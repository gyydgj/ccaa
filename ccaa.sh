...
if [ $1 = 'cdn' ]
	...
	filebrowser_url='https://github.com/filebrowser/filebrowser/releases/download/v2.17.2/freebsd-amd64-filebrowser.tar.gz'
	...
	filebrowser_url='https://github.com/filebrowser/filebrowser/releases/download/v2.17.2/linux-amd64-filebrowser.tar.gz'
	master_url='https://github.com/helloxz/ccaa/archive/master.zip'
	ccaa_web_url='http://soft.xiaoz.org/linux/ccaa_web.tar.gz'
fi
